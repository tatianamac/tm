                    	        ...
                    	        <div class="singleBody">
                                   ...
                                   <div class="postNavCont">
                    	            <?php
                    	                ...
                    	                if(isset($prevId)){
                    	                        echo '<a href="' . get_permalink($prevId) . '" class="adjPostLink"><div class="bottomLink bottomLinkPrev"><div class="cycle-prev fa fa-angle-double-left"></div><div class="adjPostDesc">Previous Post</div><div class="adjPost">' . get_the_title($prevId) . '</div></div></a>';
                    	                }
                    	                if(isset($nextId)){
                    	                    echo '<a href="' . get_permalink($nextId) . '" class="adjPostLink"><div class="bottomLink bottomLinkNext"><div class="cycle-next fa fa-angle-double-right"></div><div class="adjPostDesc">Next Post</div><div class="adjPost">' . get_the_title($nextId) . '</div></div></a>';
                    	                }
                    	            ?>
                    	        </div><!--.singleBody-->
